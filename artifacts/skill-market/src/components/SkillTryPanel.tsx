...
const EXAMPLE_PROMPTS: Record<string, string[]> = {
  ...
  Social: [
    ...
    "Create an engagement hook for a Farcaster cast about ERC-8239",
  ],
};
...
*Assumptions: 100M total supply, 4-year vesting, ERC-8239 skill registry integration*
...
We're building the infrastructure layer. ERC-8239 + ERC-8004.
...
ERC-8239 and x402 are early standards. The companies that own the rails will define the next decade of AI commerce.

**Farcaster Cast**
The AI skill market is live on Sepolia. 847 skills. 12k agent purchases. Real fees flowing to creators.
