      ...
      >
        ...
        <div style={{ height: "60vh", display: "flex", gap: "1vw" }}>
          ...
          <div style={{ flex: "1 1 0", minWidth: 0, maxWidth: "20%", background: "rgba(139,92,246,0.10)", borderRadius: "0.8vw", padding: "1.4vh 1.5vw", border: "1px solid rgba(139,92,246,0.28)", display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", gap: "1.1vh" }}>
            ...
            <div style={{ width: "3vw", height: "3vw", borderRadius: "50%", background: "rgba(139,92,246,0.15)", border: "1px solid rgba(139,92,246,0.35)", display: "flex", alignItems: "center", justifyContent: "center" }}>
            ...
            <div style={{ fontFamily: "var(--font-display-family)", fontSize: "1.6vw", fontWeight: 800, color: "#F0F0F8", lineHeight: 1.1 }}>Skill Builders</div>
            <div style={{ width: "100%", marginTop: "auto" }}>
              <div style={{ height: 1, background: "rgba(139,92,246,0.30)", marginBottom: "0.7vh" }} />
          ...
          {/* OWNER */}
          <div style={{ flex: "1 1 0", minWidth: 0, maxWidth: "20%", background: "rgba(180,160,255,0.07)", borderRadius: "0.8vw", padding: "1.4vh 1.5vw", border: "1px solid rgba(180,160,255,0.24)", display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", gap: "1.1vh" }}>
            ...
            <div style={{ width: "3vw", height: "3vw", borderRadius: "50%", background: "rgba(180,160,255,0.12)", border: "1px solid rgba(180,160,255,0.30)", display: "flex", alignItems: "center", justifyContent: "center" }}>
            ...
            <div style={{ fontFamily: "var(--font-display-family)", fontSize: "1.6vw", fontWeight: 800, color: "#F0F0F8", lineHeight: 1.1 }}>NFT Holders</div>
            <div style={{ width: "100%", marginTop: "auto" }}>
              <div style={{ height: 1, background: "rgba(180,160,255,0.25)", marginBottom: "0.7vh" }} />
          ...
          {/* CURATOR */}
          <div style={{ flex: "1 1 0", minWidth: 0, maxWidth: "20%", background: "rgba(157,163,200,0.06)", borderRadius: "0.8vw", padding: "1.4vh 1.5vw", border: "1px solid rgba(157,163,200,0.20)", display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", gap: "1.1vh" }}>
            ...
            <div style={{ width: "3vw", height: "3vw", borderRadius: "50%", background: "rgba(157,163,200,0.12)", border: "1px solid rgba(157,163,200,0.28)", display: "flex", alignItems: "center", justifyContent: "center" }}>
            ...
            <div style={{ fontFamily: "var(--font-display-family)", fontSize: "1.6vw", fontWeight: 800, color: "#F0F0F8", lineHeight: 1.1 }}>Bundle Makers</div>
            <div style={{ width: "100%", marginTop: "auto" }}>
              <div style={{ height: 1, background: "rgba(157,163,200,0.22)", marginBottom: "0.7vh" }} />
          ...
          {/* STAKER */}
          <div style={{ flex: "1 1 0", minWidth: 0, maxWidth: "20%", background: "rgba(34,211,238,0.07)", borderRadius: "0.8vw", padding: "1.4vh 1.5vw", border: "1px solid rgba(34,211,238,0.22)", display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", gap: "1.1vh" }}>
            ...
            <div style={{ width: "3vw", height: "3vw", borderRadius: "50%", background: "rgba(34,211,238,0.10)", border: "1px solid rgba(34,211,238,0.28)", display: "flex", alignItems: "center", justifyContent: "center" }}>
            ...
            <div style={{ fontFamily: "var(--font-display-family)", fontSize: "1.6vw", fontWeight: 800, color: "#F0F0F8", lineHeight: 1.1 }}>Quality Guarantors</div>
            <div style={{ width: "100%", marginTop: "auto" }}>
              <div style={{ height: 1, background: "rgba(34,211,238,0.24)", marginBottom: "0.7vh" }} />
          ...
          {/* AGENT */}
          <div style={{ flex: "1 1 0", minWidth: 0, maxWidth: "20%", background: "rgba(240,240,248,0.03)", borderRadius: "0.8vw", padding: "1.4vh 1.5vw", border: "1px solid rgba(240,240,248,0.12)", display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", gap: "1.1vh" }}>
            ...
            <div style={{ width: "3vw", height: "3vw", borderRadius: "50%", background: "rgba(240,240,248,0.08)", border: "1px solid rgba(240,240,248,0.20)", display: "flex", alignItems: "center", justifyContent: "center" }}>
            ...
            <div style={{ fontFamily: "var(--font-display-family)", fontSize: "1.6vw", fontWeight: 800, color: "#F0F0F8", lineHeight: 1.1 }}>AI Consumers</div>
            <div style={{ width: "100%", marginTop: "auto" }}>
              <div style={{ height: 1, background: "rgba(240,240,248,0.15)", marginBottom: "0.7vh" }} />
