  ...
  return (
    <div
      ...
      style={{
        background: "#0D0F14",
        backgroundImage:
          "radial-gradient(ellipse 55% 55% at 82% 42%, rgba(139,92,246,0.09) 0%, transparent 65%)"
      }}
    >
      ...
      >
        <div className="flex flex-col justify-between" style={{ width: "44vw" }}>
          <div>
            ...
            >
              KOLs are the cold-start catalyst. Their credibility drives initial skill supply and audience demand simultaneously.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-[2.5vh]">
            <div style={{ display: "flex", alignItems: "flex-start", gap: "2vw" }}>
              ...
              <div>
                ...
                >
                  KOL records their expertise. SkillFun packages it as a callable skill NFT.
                </div>
              </div>
            </div>
            ...
            <div style={{ display: "flex", alignItems: "flex-start", gap: "2vw" }}>
              <div
                style={{
                  ...
                  border: "1px solid rgba(180,160,255,0.36)",
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
                  flexShrink: 0
              ...
              <div>
                ...
                >
                  Fans claim free trial tokens via Twitter OAuth — no wallet required to start.
                </div>
              </div>
            </div>
            ...
            <div style={{ display: "flex", alignItems: "flex-start", gap: "2vw" }}>
              ...
              <div>
                ...
                >
                  Trial converts to purchase. KOL earns royalty. Cycle repeats across new KOLs.
                </div>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div className="flex flex-col gap-[2.2vh]">
              <div>
                ...
                >
                  KOLs bring their own audiences. No cold-start problem.
                </div>
              </div>
              ...
              <div>
                ...
                >
                  Followers buy the skill because they trust the person.
                </div>
              </div>
              <div style={{ height: 1, background: "rgba(139,92,246,0.15)" }} />
              <div>
                ...
                >
                  Every claim tweet is organic reach for SkillFun at zero cost.
                </div>
              </div>
            </div>
          </div>
