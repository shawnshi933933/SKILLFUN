...
import { Bot, User, TrendingUp, Lock } from "lucide-react";
        ...
        <div className="border-t border-white/10 pt-3 mt-auto">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              <div className="text-xs text-muted-foreground mb-0.5">Agent Buys</div>
              <div className="flex items-center gap-1 text-accent font-mono text-sm">
                <Bot className="w-3 h-3" />
                {skill.agentPurchaseCount.toLocaleString()}
              </div>
            </div>
            <div className="text-right">
              <div className="text-xs text-muted-foreground mb-0.5">Holders</div>
          ...
          {skill.claimedBy && (
            <div className="mt-2 text-xs text-muted-foreground">
              by <span className="text-primary">{skill.claimedBy}</span>
            </div>
          )}
        </div>
      </div>
