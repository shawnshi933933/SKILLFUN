        ...
        <div className="flex flex-col" style={{ width: "36vw", flexShrink: 0 }}>
          ...
          <div className="flex flex-col gap-[1.8vh]">
            <div style={{ display: "flex", alignItems: "flex-start", gap: "1.2vw" }}>
              <div style={{ width: "0.5vw", height: "0.5vw", background: "#8B5CF6", borderRadius: "50%", marginTop: "0.9vh", flexShrink: 0 }} />
              <div>
                <div style={{ fontFamily: "var(--font-display-family)", fontSize: "1.6vw", fontWeight: 700, color: "#F0F0F8" }}>Creators mint Skills</div>
                <div style={{ fontFamily: "var(--font-body-family)", fontSize: "1.35vw", color: "#7B7F9E" }}>Curators bundle them — no ownership required</div>
              </div>
            </div>
            <div style={{ display: "flex", alignItems: "flex-start", gap: "1.2vw" }}>
              <div style={{ width: "0.5vw", height: "0.5vw", background: "#B4A0FF", borderRadius: "50%", marginTop: "0.9vh", flexShrink: 0 }} />
              <div>
                <div style={{ fontFamily: "var(--font-display-family)", fontSize: "1.6vw", fontWeight: 700, color: "#F0F0F8" }}>Quality Bundles emerge</div>
                <div style={{ fontFamily: "var(--font-body-family)", fontSize: "1.35vw", color: "#7B7F9E" }}>Stakers back them, amplifying the discovery signal</div>
              </div>
            </div>
            <div style={{ display: "flex", alignItems: "flex-start", gap: "1.2vw" }}>
              <div style={{ width: "0.5vw", height: "0.5vw", background: "#22D3EE", borderRadius: "50%", marginTop: "0.9vh", flexShrink: 0 }} />
              <div>
                <div style={{ fontFamily: "var(--font-display-family)", fontSize: "1.6vw", fontWeight: 700, color: "#F0F0F8" }}>Agents invoke via one endpoint</div>
                <div style={{ fontFamily: "var(--font-body-family)", fontSize: "1.35vw", color: "#7B7F9E" }}>Fees split across Curator, Staker, Creator, Owner</div>
              </div>
            </div>
            <div style={{ display: "flex", alignItems: "flex-start", gap: "1.2vw" }}>
              <div style={{ width: "0.5vw", height: "0.5vw", background: "#9DA3C8", borderRadius: "50%", marginTop: "0.9vh", flexShrink: 0 }} />
              <div>
                <div style={{ fontFamily: "var(--font-display-family)", fontSize: "1.6vw", fontWeight: 700, color: "#F0F0F8" }}>Higher yields attract more Curators</div>
                <div style={{ fontFamily: "var(--font-body-family)", fontSize: "1.35vw", color: "#7B7F9E" }}>Richer Bundles → more Agents → flywheel accelerates</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "0.6vh" }}>
          ...
          <div className="relative" style={{ width: "34vw", height: "34vw" }}>
            ...
            <svg className="absolute inset-0" width="100%" height="100%" viewBox="0 0 280 280" fill="none">
              ...
              <defs>
                <marker id="fw1" markerWidth="7" markerHeight="7" refX="5" refY="3.5" orient="auto">
                  <polygon points="0 0, 7 3.5, 0 7" fill="#9DA3C8" opacity="0.7" />
                </marker>
                <marker id="fw2" markerWidth="7" markerHeight="7" refX="5" refY="3.5" orient="auto">
                  <polygon points="0 0, 7 3.5, 0 7" fill="#22D3EE" opacity="0.7" />
                </marker>
                <marker id="fw3" markerWidth="7" markerHeight="7" refX="5" refY="3.5" orient="auto">
                  <polygon points="0 0, 7 3.5, 0 7" fill="#B4A0FF" opacity="0.7" />
                </marker>
                <marker id="fw4" markerWidth="7" markerHeight="7" refX="5" refY="3.5" orient="auto">
                  <polygon points="0 0, 7 3.5, 0 7" fill="#9DA3C8" opacity="0.7" />
                </marker>
              </defs>
            </svg>
